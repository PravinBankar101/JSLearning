...
var dayOfWeek = function (day) {
    switch (day) {
      ...
      case 7:
        ...
        break;
      default:
          console.log(`${day} - In valid input`);  //**imp --> main use of switch case is we dont need to first check
                                                   // for every invalid input data( in if/ ifelse block we need to check it firstly).
                                                    // here we can directly log for invalid input in default case of switch block.
