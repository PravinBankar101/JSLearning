...
var result = +num3;                //** --> (+stringName) is used to convert string into number
// var result= 100;
console.log(`value of  result is: ${result}`);
...
var resultNum4 = +num4;   
//  var resultNum4 = NaN;
console.log(`Value of resultNum4 is: ${resultNum4}`);
...
var num = 100;
var result = Boolean(num);   //in boolean---> 0 means false ; any value >=1 means true
console.log(`Result is ${result} and it's type is: ${typeof result}` );
